...
export default async function SettingsPage() {
  ...
  return <SettingsClient 
    organization={{
      ...
      mollie_account_id: currentMember.organizations.mollie_account_id,
      mollie_charges_enabled: currentMember.organizations.mollie_charges_enabled,
      mollie_account_status: currentMember.organizations.mollie_account_status,
