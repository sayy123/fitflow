...
export default function LegalPage() {
  return (
    <div className="min-h-screen bg-card text-foreground font-sans p-8 md:p-24">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-foreground/80 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">2. Contact</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">5. Données personnelles et RGPD</h2>
            <p>
