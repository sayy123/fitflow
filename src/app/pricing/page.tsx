    ...
    <div className="min-h-screen bg-[#FAFAFA] text-foreground selection:bg-zinc-200 font-sans overflow-hidden">
      ...
      <main className="pt-32 pb-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted text-zinc-800 text-xs font-semibold mb-6 ring-1 ring-zinc-200/80 shadow-sm cursor-default">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-card rounded-[2.5rem] p-8 md:p-10 shadow-sm border border-border/60 flex flex-col relative">
            ...
            <Link href="/register?role=manager&plan=starter" className="mb-10 w-full">
              <Button variant="outline" className="w-full rounded-full h-14 text-base font-semibold border-border bg-card text-zinc-700 hover:bg-background hover:text-foreground transition-colors shadow-sm">
          ...
          <div className="bg-zinc-900 rounded-[2.5rem] p-8 md:p-10 shadow-xl flex flex-col relative overflow-hidden group">
            ...
            <div className="absolute top-8 right-8">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-card/10 text-white text-[10px] font-bold uppercase tracking-widest backdrop-blur-md border border-white/10">
                Populaire
              </div>
            </div>
            ...
            <div className="mb-8 relative z-10">
              ...
              <p className="text-muted-foreground text-sm font-medium">L'outil complet pour les studios établis en pleine croissance.</p>
            </div>
            ...
            <Link href="/register?role=manager&plan=premium" className="mb-10 w-full relative z-10">
              <Button className="w-full bg-card text-foreground rounded-full h-14 text-base font-bold hover:bg-muted hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl ring-1 ring-inset ring-white/10">
        ...
        <section className="mt-32 max-w-3xl mx-auto text-center border-t border-border/60 pt-20">
          ...
          <Button variant="outline" className="rounded-full px-8 h-12 text-sm font-semibold border-border text-zinc-700 hover:bg-background">
            Nous contacter
          </Button>
        </section>
      </main>
